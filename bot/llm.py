...
DIGEST_SYSTEM_PROMPT = (
    ...
    "новостей собери компактный дайджест в стиле новостного вещания. По каждой "
    "новости ровно 1–2 коротких предложения (до ~110 символов на булет): что "
    "произошло и почему это важно читателю. Без канцелярита, без выдуманных "
    "фактов (бери только из текста). Не вставляй URL и слова «источник» в булет.\n"
    "Советов не более 2, каждый до ~80 символов, иначе выпуск не поместится в "
    ...
    '"bullets":["по 1-2 коротких предложения на новость"], '
