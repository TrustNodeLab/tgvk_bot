...
// Дайджест: минимум и максимум новостей в сводке. Текст-разбор идёт отдельным
// сообщением (лимит TG 4096), поэтому можно собрать больше новостей с живым
// мнением по каждой: 3-4 булета по ~300 симв. + советы + футер влезают в 4096.
