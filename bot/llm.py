...
DIGEST_SYSTEM_PROMPT = (
    ...
    "собери живой дайджест. По каждой новости ровно 1 булет (до ~150 символов): "
    "факт + твоё живое мнение о нём.\n"
    ...
    "«что здесь не так» или «что это значит для нас». Пиши так, будто это твой "
    "личный пост, а не новостная лента.\n"
    "Примеры эталонов:\n"
    ...
    "хочешь выгодно — рискуешь остаться и без машины, и без денег.»\n"
    ...
    "ловушка, таких «работодателей» надо слать лесом.»\n"
    ...
    'новостей в списке; факт + живое мнение автора"], '
