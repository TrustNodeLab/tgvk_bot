...
// Дайджест: минимум и максимум новостей в сводке. MAX=2, чтобы каждую новость
// можно было разобрать развёрнутым абзацем и весь выпуск влезал в лимит TG
// 1024 символов (разбор длиннее, чем сжатая сводка из 3 булетов).
