...
DIGEST_SYSTEM_PROMPT = (
    ...
    "РОВНО 2–3 предложения, как диктор новостей — что произошло, какие цифры, "
    "почему это важно читателю. Не пиши один абзац за новость и не ужимай до "
    "одного предложения; вещательный тон ведущего, живой язык, без канцелярита "
    "и без выдуманных фактов (бери только из текста).\n"
